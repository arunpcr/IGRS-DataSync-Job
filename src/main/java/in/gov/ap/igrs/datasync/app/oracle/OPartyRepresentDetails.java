...
public class OPartyRepresentDetails {
	...
	final static Logger logger = LogManager.getLogger(OPartyRepresentDetails.class.getClass());
	   ...
	   try {
	      // Update ec_firms table with values from party_details collection
		   con=OracleDBUtil.getConnection();
	         ...
	         List<String> partyDetailsList = MongoDBOperation.INSTANCE.getPartyDetailsCollectionDataFromID(mongoDBUrl, dbName, "party_details", mData.getParentPartyId());
...
public static boolean updateDocumentDetails(PartyRepresentDetails mData, String mongoDBUrl, String dbName) throws SQLException {
	   ...
	   try {
	      ...
	      if (mData.isPresenter() == true) {
	         ...
	         List<String> partyDetails = MongoDBOperation.INSTANCE.getPartyDetailsCollectionDataFromID(mongoDBUrl, dbName, "party_details", mData.getParentPartyId());
