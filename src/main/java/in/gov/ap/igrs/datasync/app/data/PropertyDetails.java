...
public void settUnits(String tUnits) {
	...
	public String toString() {
		return "PropertyDetails [propertyId=" + propertyId + ", tExtent=" + tExtent + ", localBodyCode=" + localBodyCode
				...
				+ ", southBoundry=" + southBoundry + ", landUseCode=" + landUseCode + ", lpmNo=" + lpmNo
				+ ", extentList=" + ExtentList + ", seqNumber=" + seqNumber + ", habitationCode=" + habitationCode
				+ ", sroCode=" + sroCode + ", mandal=" + mandal + ", villageCode=" + villageCode + ", marketValue="
				+ marketValue + ", tUnits=" + tUnits + ", village=" + village + ", district=" + district + ", locality="
				+ locality + ", amount=" + amount + ", dateOfExecution=" + dateOfExecution + ", dateOfStampPurchase="
				+ dateOfStampPurchase + ", habitation=" + habitation + ", localBodyType=" + localBodyType
				+ ", survayNo=" + survayNo + ", localBodyName=" + localBodyName + ", jurisdictionDistrict="
				+ jurisdictionDistrict + ", jurisdictionSRO=" + jurisdictionSRO + ", propertyType=" + propertyType
				+ ", applicationId=" + applicationId + ", sroOffice=" + sroOffice + ", landUse=" + landUse
				+ ", stampPaperValue=" + stampPaperValue + ", totalConsiderationValue=" + totalConsiderationValue
